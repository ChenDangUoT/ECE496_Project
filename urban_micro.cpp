...
void urban_micro::set_d_n_m_AoD_from_table(path &this_path){
    ...
    this_subpath_base[0].set_d_AoD(0.2236/180.0*PI);
    this_subpath_base[1].set_d_AoD(-0.2236/180.0*PI);
    this_subpath_base[2].set_d_AoD(0.7064/180.0*PI);
    this_subpath_base[3].set_d_AoD(-0.7064/180.0*PI);
    this_subpath_base[4].set_d_AoD(1.2461/180.0*PI);
    this_subpath_base[5].set_d_AoD(-1.2461/180.0*PI);
    this_subpath_base[6].set_d_AoD(1.8578/180.0*PI);
    this_subpath_base[7].set_d_AoD(-1.8578/180.0*PI);
    this_subpath_base[8].set_d_AoD(2.5642/180.0*PI);
    this_subpath_base[9].set_d_AoD(-2.5642/180.0*PI);
    this_subpath_base[10].set_d_AoD(3.3986/180.0*PI);
    this_subpath_base[11].set_d_AoD(-3.3986/180.0*PI);
    this_subpath_base[12].set_d_AoD(4.4220/180.0*PI);
    this_subpath_base[13].set_d_AoD(-4.4220/180.0*PI);
    this_subpath_base[14].set_d_AoD(5.7403/180.0*PI);
    this_subpath_base[15].set_d_AoD(-5.7403/180.0*PI);
    this_subpath_base[16].set_d_AoD(7.5974/180.0*PI);
    this_subpath_base[17].set_d_AoD(-7.5974/180.0*PI);
    this_subpath_base[18].set_d_AoD(10.7753/180.0*PI);
    this_subpath_base[19].set_d_AoD(-10.7753/180.0*PI);
